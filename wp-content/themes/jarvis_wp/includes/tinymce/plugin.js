		...
		createControl: function ( btn, e )
		{
			...
			{	
				...
				{		
					...
					a.addImmediate( b, "Blog Posts","[blog posts=\"10\" columns=\"2 or 3 or 4\" title=\"Recent Posts Title\" show_title=\"true\" categories=\"all or category_id\" excerpt_size=\"10\"]" );
					...
					a.addImmediate( c, "Icon Box","[icon_box icon=\"fa-class or Icon image URL\" title=\"Service Box Title Here\" icon_type=\"image or fa-font\"]Give icon={icon class name from Font Awesome List} for icon_type={fa-font} and icon={htttp:// iconimageurl} for icon_type={image}[/icon_box]" );
					...
					a.addImmediate( c, "Service Box","[service_box icon=\"fa-class\" title=\"Service Box Title Here\"]Give icon={icon class name from Font Awesome List}[/service_box]" );
					...
					a.addImmediate( c, "Home Quote 2","[home_callout2]<br>\
